  ...
  return (
    <Stack>
      ...
      <Stack>        
          ...
          {(vaultInfo?.debtAmount??0) >= 200 ? <Text variant="title" justifyContent="center" display={"flex"} fontSize={"md"} letterSpacing={"1px"} mb={1} color={"#e73a3a"} >Alert: Deposits DISABLED while above 200 debt</Text> : null}
