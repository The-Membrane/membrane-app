...
export const rpcUrl = 'https://osmosis-rpc.numia.xyz' //'https://g.w.lavanet.xyz:443/gateway/osmosis/rpc-http/c6667993e9a0fac0a9c98d29502aa0a7'//'https://osmosis-rpc.polkachu.com/'////'https://rpc.cosmos.directory/osmosis' //'https://rpc.osmosis.zone/'//// //
