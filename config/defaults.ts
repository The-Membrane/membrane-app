...
export const colors = {
  globalBG: "rgb(2, 6, 23)",
  global: "rgb(245, 241, 241)",
  tabBG: "primary.200",
  summaryScheme: "rgb(64, 255, 168)",
  noState: "rgb(167, 178, 199)",
  link: "primary.200",
  linkHover: "primary.300",
  sliderCardBorder: "rgb(170, 85, 255)",
  slider: "rgb(0, 255, 255)",
  alert: "rgb(255, 61, 87)",
  textHighlight: "rgb(200, 255, 255)",
  earnText: "rgb(245, 241, 241)",
  sliderThumb: "blue.500",
  collateralScrollBG: "rgb(3, 3, 32)",
  sliderTrack: "rgb(245, 241, 241)",
  walletIcon: "rgb(191, 85, 255)",
  emptyLoader: "rgba(250, 129, 253, 0.57)",
  loader: "primary.500",
  cardBG: "rgb(22, 28, 54)",
  inputBorder: "rgb(152, 71, 148)",
  inputBG: "rgb(8, 12, 28)",
  modalBG: "rgb(20, 20, 46)",
  textLight: "rgba(255, 255, 255, 0.6)",
  p100: "rgb(222, 243, 255)",
  p200: "rgb(19, 154, 255)",
  p300: "rgb(0, 113, 235)",
  p400: "rgb(0, 87, 196)",
  p500: "rgb(0, 66, 167)",
