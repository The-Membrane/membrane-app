      ...
      <Stack>        
          ...
          <Card>
              ...
              <Text variant="body" mb={1}>
                This vault <Text fontWeight={"bold"}>supplies USDC on Mars Protocol</Text> and loops it by collateralizing the Mars position to mint CDT,
              ...
              <Text variant="body" mb={1}> The vault's collateral position is open for <Text fontWeight={"bold"}>profitable debt redemptions</Text> that act as downside liquidity for CDT which adds additional yield to depositors while keeping CDT's peg tight.              </Text>    
              <Text variant="body" mb={1}>On top of that, there is a <Text fontWeight={"bold"}>0.5% entry fee</Text> in order to account for the slippage it takes to unloop & withdraw USDC.
              ...
              <Text variant="body" mb={1}>Your TVL represents a portion of the vault's TVL. The vault's TVL may temporary decrease as <Text fontWeight={"bold"}>it takes $1 of CDT in debt and sells it</Text>, the lowest conversion rate being $.99. This difference will be recouped as users withdraw or as the vault's CDP position gets redeemed against. Redemptions & the entry fee to remaining users realized as users withdraw can be profitable as stated above so this flucuation is temporary & part of the vault's normal functionality.</Text>
            </Card>
        </Stack>
        <Stack>    
