...
const initialState: NeuroState = {
  assets: [{ symbol: "WBTC", label: "WBTC", display: "WBTC", value: "WBTC", combinUsdValue: 1, maxBorrowLTV: 0.5, balance: 0, logo: "https://raw.githubusercontent.com/cosmos/chain-registry/master/osmosis/images/wbtc.axl.png" }],
  guardedPositions: [],
  closeInputValue: 0,
