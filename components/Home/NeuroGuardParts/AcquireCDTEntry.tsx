...
import { Card, Text, Stack, HStack, Button, Image, Checkbox, List, ListItem, Input, TabIndicator, TabList, Tabs, CardBody, CardFooter } from "@chakra-ui/react"
...
// Extracted AcquireCDTEntry component
const AcquireCDTEntry = React.memo(function AcquireCDTEntry({
  usdcBalance,
  RBYield,
  rblpDeposit,
  address
  ...
  }, [quickActionState?.usdcSwapToCDT, setQuickActionState, maxAmount, txType])
        ...
        <Card width="fit-content" alignSelf="center" borderWidth={3} padding={4} bg="rgb(90, 90, 90, 0.4)" borderColor="rgba(255, 255, 255, 0.16)">
          <Stack gap="1.5rem">
            ...
            <List spacing={3} styleType="disc" padding="6" paddingTop="0">
              <ListItem fontFamily="var(--font-inter)" fontSize="md"> All in stablecoins. Sourced from revenue & LP profits.</ListItem>
              <ListItem fontFamily="var(--font-inter)" fontSize="md"> 100% liquid. No lock-in or withdrawal penalty.</ListItem>
              <ListItem fontFamily="var(--font-inter)" fontSize="md"> Earn 100 MBRN for every $1 in yield you earn.</ListItem>
            </List>
          </Stack>
...
export default AcquireCDTEntry
