...
const Layout = ({ children }: Props) => {
  ...
  // console.log("show", rulesState.show)
  ...
  return (
    ...
    <Stack w="100vw" h="100vh" display={['flex']} position="relative" direction={{ base: "column", md: "column" }}>
      ...
      >
        {/* <Header /> */}
        <Stack as="main" spacing={0} p={0} overflow="visible" height="auto" minH="unset" maxH="unset" paddingLeft={"3"} w="full" flex={1} mt={{ base: "0px", md: "15px" }}>
          <RPCStatus />
          {children}
        </Stack>
      </Stack>
