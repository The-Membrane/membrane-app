...
const EarnCard = () => {
    ...
    return (
        <Card width={"33%"} borderColor={""} borderWidth={3} padding={4}>
          <Stack>             
            <Text fontFamily="Inter" variant="title" fontSize={"md"} letterSpacing={"1px"} justifyContent={"center"} display="flex" color="rgb(226, 216, 218)">Earn USDC</Text>
            <Stack>
                ...
                <Text fontFamily="Inter" variant="title" fontSize={"lg"} letterSpacing={"1px"} display="flex"><a style={{fontWeight:"bold", color:"rgb(226, 216, 218)"}}>Estimated APR: &nbsp;</a> {longestAPR}</Text>
            </Stack>
            <Divider marginBottom={"3vh"}/> 
            <List spacing={3} styleType="disc" padding="6" paddingTop="0">
              <ListItem fontFamily="Inter" fontSize="md"><a style={{fontWeight:"bold", color:"#20d6ff"}}>Yield:</a> Looped Mars USDC yield, CDT Redemptions & 0.5% entry fee</ListItem>
              <ListItem fontFamily="Inter" fontSize="md">You <a style={{fontWeight:"bold", color:"rgb(231, 58, 58)"}}>pay</a> unloop costs to exit</ListItem>
              <ListItem fontFamily="Inter" fontSize="md">Deposits <a style={isDisabled ? {fontWeight:"bold", color:"rgb(231, 58, 58)"} : {}}>disabled</a> above 200 Debt</ListItem>
            </List>
