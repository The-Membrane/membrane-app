...
const RangeBoundInfoCard = ({ RBYield }: { RBYield: string }) => {
    ...
    return (
        <Card gap={0} width={"32%"} borderWidth={3} height={"69%"} alignSelf="start">
            <Stack height="100%">
                ...
                <List spacing={3} styleType="disc" padding="6" paddingTop="0">
                    <ListItem fontFamily="Inter" fontSize="md" fontWeight={"bold"}>Current APR: {num(RBYield).times(100).toFixed(1)}%</ListItem>
